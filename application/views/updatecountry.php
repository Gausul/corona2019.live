...
foreach ($country_data as $cd) {
   $sum=$sum+$cd->total_case;
    ?>           
<input type="hidden" name="country_id[]" value="<?=$cd->country_id;?>">
     <tr>
                    <td><?=$cd->country_name;?></td>
                    <td><input type="text" name="total_cases[]" value="<?=$cd->total_case;?>"></td>
                    <td><input type="text" name="recovered_cases[]" value="<?=$cd->recovered_cases;?>"></td>
                    <td><input type="text" name="fatal_cases[]" value="<?=$cd->fatal_cases;?>"></td>
                  </tr>
<?php } ?>
